package main.java.home.javarush.javaSyntax.task16.task1610;
...
/*
    Тренировка на время
        ...
        В методе main() создай объект LocalTime, используя часы из time1 (time1.getHour()), минуты из time2,
        секунды из time3, наносекунды из time4. Выведи его в консоль.
