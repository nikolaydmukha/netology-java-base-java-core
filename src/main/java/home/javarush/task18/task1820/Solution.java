package main.java.home.javarush.task18.task1820;
...
public class Solution {
    ...
    public static Optional<Car> getMostExpensiveCar(Stream<Car> cars) {
        ...
        return cars.max((item1, item2) -> item1.compareTo(item2));
    }

    public static Optional<Car> getMoreExpensiveCar(Stream<Car> cars, Car mostExpensiveCar) {
        //напишите тут ваш код
        return cars.filter(item -> item.getPrice() > mostExpensiveCar.getPrice()).findFirst();
    }
}
